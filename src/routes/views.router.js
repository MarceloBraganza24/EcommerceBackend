...
export default class ViewsRouter extends Router {
    init() {
        ...
        this.get('/shopping-cart-user-view', [accessRolesEnum.ADMIN, accessRolesEnum.PREMIUM], passportStrategiesEnum.JWT, shoppingCartUserView);
        this.get('/finalize-purchase-view', [accessRolesEnum.ADMIN, accessRolesEnum.PREMIUM], passportStrategiesEnum.JWT, finalizePurchaseView);
        ...
        this.get('/resetPass-view', [accessRolesEnum.ADMIN, accessRolesEnum.PREMIUM], passportStrategiesEnum.JWT, resetPassView);
        this.get('/newPass-view', [accessRolesEnum.ADMIN, accessRolesEnum.PREMIUM], passportStrategiesEnum.JWT, newPassView);
    }
}